...
已记录的扩展 K6V 证据：精确候选 `c474ccd18769544a3d7a08facf4147dfe6305bee`（tree `f6983b3b3d713827f593a2f7954c550ef74fec83`）已通过 [workflow run 29754014231](https://github.com/ycfeng/ocdeck-android/actions/runs/29754014231)。API 26 Android 8.0.0 完成单 profile x86_64 `compat` suite，API 36 Android 16 完成 x86_64 12-profile `full` suite；两者均报告 4 KiB page。合并 artifact `k6v-frpc-android-interop-c474ccd18769544a3d7a08facf4147dfe6305bee` 状态为“通过”，GitHub artifact digest 为 `sha256:e70f9d2033e963ce287a61641fab318d070ab51262ee61aa22ce34fd71031a4c`。报告验证了固定 backend 顺序、语义结果、精确 checks、同端口重绑、全部 wire/payload 组合、三个负例以及 restart/control-epoch 恢复。它仍设置 `authorizesKotlinDefault=false`，且不能满足物理 ARM/16KB、App 的真实 Store/快照/reconciliation 链路、Doze/网络/前后台、性能、资源泄漏、长期 soak 或正式稳定发布周期门禁。
