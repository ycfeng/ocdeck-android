...
- [ ] `:app:testDebugUnitTest`, `:app:testCanaryUnitTest`, `:app:testKotlinReleaseUnitTest`, `:frpc-stcp-visitor:testDebugUnitTest`, `:app:assembleDebug`, `:app:assembleCanary`, `:app:assembleKotlinRelease`, and the required bridge gate passed; variant factory tests confirmed Debug/GoMobile, Canary/Kotlin, and Kotlin Release-Like/Kotlin selection.
...
- [ ] Canary and Kotlin Release-Like APKs remained verification outputs only. Kotlin Release-Like used the standard Android Debug test certificate for physical Release-mode validation; Release signing and release staging used only the GoMobile-default `assembleRelease` outputs.
