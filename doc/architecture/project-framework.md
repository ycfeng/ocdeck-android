...
1. With the phase-one exact-SHA API 26/API 36 K6V artifact reviewed, repeat the host matrix's critical wire v1/v2, payload, concurrent REST/SSE, and restart/control-epoch paths on physical target-ABI and 16KB devices. Collect performance, long-duration soak, and resource evidence before considering Kotlin-default assembly.
