...
The existing `app/src/androidTest` coverage is limited to localized independent-window roots, and CI has no emulator/instrumentation job. Recent-project ordering interactions therefore remain manual device checks against this matrix:
