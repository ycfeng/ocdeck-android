...
| STCP concurrency and recovery | Core available | Readiness, generation/control epoch, AAR gates, and a phase-one real Android GoMobile-to-Kotlin A/B harness exist. Exact-SHA candidate `459c2b57ebf465d6b933ea939f59fa739128ec59` passed the API 26/API 36 x86_64 emulator workflow on 4 KiB pages, and its bilingual report was reviewed. Physical target ABIs, 16KB devices, the full wire/payload/negative/restart matrix, network/foreground transitions, performance, resource-leak, and soak evidence remain required |
...
| Priority | Work |
| --- | --- |
| High | Expand the reviewed phase-one exact-SHA Android STCP evidence to physical ARM/16KB devices, wire/payload/restart paths, performance, resource-leak, and soak testing before any Kotlin-default decision |
