...
| STCP bridge artifact | Fixed GoMobile bridge `0.3.8-frp0.69.1-p1` | Tested | Automated gates verify checksum, Java API, provenance, ABIs, ELF machine, 16KB `PT_LOAD` alignment, stripped state, and reproducibility. |
